...
<body>
	...
	<div class="content">
		...
		<div id="div1">
			<ul>
				<?php if(!empty($show)){ foreach($show as $v){ ?>
		    	<li><a href="<?=Url::toRoute('show/indexs')?>"><img src="<?=$v['pic']?>" /></a></li>
		    	<?php }} ?>
		    </ul>
		    <div id="btn">
		...
		<div class="shouyi_list"style="margin:20px auto;width:400px">
			<a href="<?=Url::toRoute('show/indexs')?>">old show</a>
		</div>
	</div>
	<!-- 内容结束 -->
