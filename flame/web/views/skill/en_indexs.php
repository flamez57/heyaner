...
<body>
	...
	<div class="content">
		<div class="show_list">
			<ul>
				<?php if(!empty($skill)){ foreach($skill as $k=>$v){ ?>
				<li <?=($k==0)?'style="z-index:2;opacity:1;fliter:alpha(opacity=100);"':'';?>>
					<a href="<?=Url::toRoute(['skill/detail','id'=>$v['id']])?>"><img class="coat" src="<?=$v['pic']?>" alert="mysweet"/></a><a href="<?=Url::toRoute(['skill/detail','id'=>$v['id']])?>"class="show_a"><?=empty($v['name'])?'':$v['name'];?><?=empty($v['skill'])?'':$v['skill'];?><?=empty($v['title'])?'':$v['title'];?></a>
				</li>
				<?php }} ?>
			</ul>
		</div>
		<div class="pages">
			<a href="<?=Url::toRoute(['skill/indexs','p'=>1])?>">1</a>
			<a href="<?=Url::toRoute(['skill/indexs','p'=>2])?>">2</a>
			<a href="<?=Url::toRoute(['skill/indexs','p'=>3])?>">3</a>
			<a href="<?=Url::toRoute(['skill/indexs','p'=>4])?>">4</a>
			<a href="<?=Url::toRoute(['skill/indexs','p'=>5])?>">5</a>
		</div>
	</div>
	<!-- 内容结束 -->
